...
`ignore-non-standard` is an option that allows you to specify whether only standard properties from our [properties list](https://github.com/sasstools/sassy-lint/blob/master/data/properties.yml) should be affected by this rule or if any prefixed property / element should be affected.
