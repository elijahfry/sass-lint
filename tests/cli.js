...
describe('cli', function () {
  ...
  it('should return help instructions', function (done) {
    var command = 'node bin/sassy-lint -h';
  ...
  it('should return a version', function (done) {
    var command = 'node bin/sassy-lint --version';
  ...
  it('should not try to read and lint a directory', function (done) {
    var command = 'node bin/sassy-lint "tests/dir-test/**/*.scss" --no-exit --verbose --format json';
  ...
  it('Should accept multiple input paths', function (done) {
    var command = 'node bin/sassy-lint "tests/cli/cli-error.scss, tests/cli/cli-error.sass" --no-exit --verbose';
  ...
  it('Should accept multiple input globs', function (done) {
    var command = 'node bin/sassy-lint "tests/cli/*.scss, tests/cli/*.sass" --no-exit --verbose';
  ...
  it('Should accept multiple input paths from a config file', function (done) {
    var command = 'node bin/sassy-lint -c tests/yml/.multiple-inputs.yml --no-exit --verbose';
  ...
  it('Should accept multiple input paths and multiple ignore paths', function (done) {
    var command = 'node bin/sassy-lint "tests/cli/cli-error.scss, tests/cli/cli-error.sass" -i "tests/cli/cli-error.scss, tests/cli/cli-error.sass" --no-exit --verbose';
  ...
  it('Should accept multiple input paths and multiple ignores from a config file', function (done) {
    var command = 'node bin/sassy-lint -c tests/yml/.multiple-ignores.yml --no-exit --verbose';
  ...
  it('CLI format option should output JSON', function (done) {
    var command = 'node bin/sassy-lint -c tests/yml/.stylish-output.yml tests/cli/cli.scss --verbose --format json';
  ...
  it('CLI output option should write to test file', function (done) {
    var command = 'node bin/sassy-lint -c tests/yml/.stylish-output.yml tests/cli/cli.scss --verbose --format json --output tests/cli-output.json',
  ...
  it('should return JSON from .sassy-lint.yml', function (done) {
    var command = 'node ../../../bin/sassy-lint ../../cli/cli.scss --verbose';

    exec(command, { cwd: path.join(__dirname, 'yml', '.sassy-lint.yml') }, function (err, stdout) {
  ...
  it('should return JSON from .sasslintrc', function (done) {
    var command = 'node ../../../bin/sassy-lint ../../cli/cli.scss -c ".sasslintrc" --verbose';
  ...
  it('should return JSON from a custom config', function (done) {
    var command = 'node bin/sassy-lint -c tests/yml/.color-keyword-errors.yml tests/cli/cli.scss --verbose';
  ...
  it('output should return no errors/warnings', function (done) {
    var command = 'node bin/sassy-lint -c tests/yml/.json-lint.yml tests/cli/cli.scss --verbose';
  ...
  it('should return a warning - stylish', function (done) {
    var command = 'node bin/sassy-lint -c tests/yml/.stylish-errors.yml tests/cli/cli.scss --verbose',
  ...
  it('should not include ignored paths', function (done) {
    var command = 'node bin/sassy-lint -i "**/*.scss" -v -q --format json "**/cli/*.scss"';
  ...
  it('should not include multiple ignored paths', function (done) {
    var command = 'node bin/sassy-lint -i "**/*.scss, **/*.sass" -q -v --format json';
  ...
  it('should override filename convention if a valid --syntax is provided', function (done) {
    var command = 'node bin/sassy-lint --syntax scss tests/cli/cli.txt --verbose --format json';
  ...
  it('should exit with error when quiet', function (done) {
    var command = 'node bin/sassy-lint -c tests/yml/.error-output.yml tests/cli/cli-error.scss --verbose --no-exit';
  ...
  it('should exit with error when more warnings than --max-warnings', function (done) {
    var command = 'node bin/sassy-lint -c tests/yml/.color-keyword-errors.yml tests/cli/cli.scss --max-warnings 0';
  ...
  it('should not exit with an error if no config is specified', function (done) {
    var command = 'node bin/sassy-lint tests/cli/cli-clean.scss --verbose --no-exit';
  ...
  it('parse errors should report as a lint error', function (done) {
    var command = 'node bin/sassy-lint --config tests/yml/.stylish-output.yml tests/sass/parse.scss --verbose --no-exit --format json';
...
describe('Reading files with UTF-8 BOM', function () {
  ...
  it('should not throw a parse error from file containing a BOM', function (done) {
    var command = 'node bin/sassy-lint -v tests/bom-utf8/starts-with-mixin-utf8-bom.scss --format json';

    exec(command, function (err, stdout) { // eslint-disable-line handle-callback-err
      var result = JSON.parse(stdout)[0];

      // Files with BOM markers that start with a mixin throw a fatal error
      // https://github.com/sasstools/sassy-lint/issues/880
  ...
  it('should return the correct amount of warnings from a file containing BOM markers', function (done) {
    var command = 'node bin/sassy-lint -v tests/bom-utf8/var-utf8-bom.scss --format json';

    exec(command, function (err, stdout) { // eslint-disable-line handle-callback-err
      var result = JSON.parse(stdout)[0];

      // Files starting with variables threw extra errors
      // see https://github.com/sasstools/sassy-lint/issues/880
      assert.equal(result.errorCount, 0);
