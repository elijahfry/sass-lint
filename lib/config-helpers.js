...
/**
 * Loads the default sassy-lint configuration file
 *
 * @returns {Object} The default sassy-lint configuration
 */
var loadDefaults = function loadDefaults () {
  return yaml.safeLoad(fs.readFileSync(path.join(__dirname, 'config', 'sassy-lint.yml'), 'utf8'));
};
